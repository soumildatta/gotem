...
const RequestCards = ( {data} ) => {
    return(
                ...
                <tr>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                  <button class="px-8 py-4 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 hover:bg-green-200 text-green-800">
                      Accept
                    </button>
                  <button class="px-8 py-4 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 hover:bg-red-200 text-red-800">
                      Decline
                  </button>  
                  </td>
                </tr>
