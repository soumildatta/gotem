  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl w-full space-y-10">
        <h2 className="mt-6 text-center text-6xl font-extrabold text-gray-900 flex justify-left ">
          Request a Ride
        </h2>
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="rounded-md shadow-0 space-y-6">
            <div className="flex flex-col">
              <label for="info" className="text-lg">
                Info:
              </label>
              <select
                name="info"
            ...
            <div>
              ...
              <label for="your-location" class="sr-only">
                Your location
              </label>
              <input
                id="your-location"
            ...
            <div className="flex justify-between py-2">
              <button
                type="button"
                class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-red-500 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 m-2"
              >
                Cancel
              </button>
              <button
                type="submit"
                class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-500 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 m-2"
              >
                Submit
              </button>
            </div>
